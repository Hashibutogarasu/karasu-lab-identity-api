...
export const authEnvSchema = z.object({
  ...
  BLUESKY_AUTHORIZATION_URL: z.string().url().optional(),
  BLUESKY_TOKEN_URL: z.string().url().optional(),
  BLUESKY_USERINFO_URL: z.string().url().optional(),
  BLUESKY_REFRESH_TOKEN_SECRET: z.string().optional(),
