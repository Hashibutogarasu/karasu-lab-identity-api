...
const interfacePlugin: ReturnType<typeof oauthApplicationPluginInterface> =
...
> {
  ...
  readonly options = interfacePlugin.endpoints.all
    .options as typeof interfacePlugin.endpoints.all.options;

  execute = async (
    ctx: EndpointContext<typeof this.path, typeof this.options> & {
      context: AuthContext;
    },
...
> {
  ...
  readonly options = interfacePlugin.endpoints.getApp
    .options as typeof interfacePlugin.endpoints.getApp.options;
...
> {
  ...
  readonly options = interfacePlugin.endpoints.byClientId
    .options as typeof interfacePlugin.endpoints.byClientId.options;
...
> {
  ...
  readonly options = interfacePlugin.endpoints.updateDisabled
    .options as typeof interfacePlugin.endpoints.updateDisabled.options;
...
> {
  ...
  readonly options = interfacePlugin.endpoints.update
    .options as typeof interfacePlugin.endpoints.update.options;
...
> {
  ...
  readonly options = interfacePlugin.endpoints.regenerateSecret
    .options as typeof interfacePlugin.endpoints.regenerateSecret.options;
...
> {
  ...
  readonly options = interfacePlugin.endpoints.delete
    .options as typeof interfacePlugin.endpoints.delete.options;
