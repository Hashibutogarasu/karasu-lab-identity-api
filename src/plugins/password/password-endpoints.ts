...
const interfacePlugin: ReturnType<typeof passwordPluginInterface> =
...
> {
  ...
  readonly options = interfacePlugin.endpoints.verify
    .options as typeof interfacePlugin.endpoints.verify.options;
...
> {
  ...
  readonly options = interfacePlugin.endpoints.set
    .options as typeof interfacePlugin.endpoints.set.options;
